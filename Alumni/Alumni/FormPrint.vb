...
Public Class FormPrint
    ...
    Private Sub loadRecords()
        ...
        myCmd.CommandText = "SELECT Fname, Sex, round((floor(datediff(now(),bday))/360)) AS 'age', Bday, Stat, HomeA, City, Num, Email, Tribe, Religion, EA, TA, Phase, Yearg FROM vsbt WHERE City LIKE '%" & Mcity & "%' " & phasecondition & " ;"
    ...
    Private Sub searchStudent()
        ...
        If txtSearch.Text = "" And txtYear.Text <> "" Then
            If chkPhase1.Checked = True And chkPhase2.Checked = True Then
                myCmd.CommandText = "SELECT Fname, Sex, Stat, round((floor(datediff(now(),bday))/360)) AS 'age', Bday, HomeA, City, Tribe, TA, Religion, Num, Yearg, EA, Email, Phase FROM vsbt WHERE  yearg ='" & txtYear.Text & "' AND City LIKE '%" & Mcity & "%' ORDER BY Fname ;"
            ElseIf chkPhase1.Checked = True And chkPhase2.Checked = False Then
                myCmd.CommandText = "SELECT Fname, Sex, Stat, round((floor(datediff(now(),bday))/360)) AS 'age', Bday, HomeA, City, Tribe, TA, Religion, Num, Yearg, EA, Email, Phase FROM vsbt WHERE yearg ='" & txtYear.Text & "' AND City LIKE '%" & Mcity & "%' AND phase =1 ORDER BY Fname ;"
            ElseIf chkPhase1.Checked = False And chkPhase2.Checked = True Then
                myCmd.CommandText = "SELECT Fname, Sex, Stat, round((floor(datediff(now(),bday))/360)) AS 'age', Bday, HomeA, City, Tribe, TA, Religion, Num, Yearg, EA, Email, Phase FROM vsbt WHERE yearg ='" & txtYear.Text & "' AND City LIKE '%" & Mcity & "%' AND phase =2 ORDER BY Fname ;"
            ElseIf chkPhase1.Checked = False And chkPhase2.Checked = False Then
                myCmd.CommandText = "SELECT Fname, Sex, Stat, round((floor(datediff(now(),bday))/360)) AS 'age', Bday, HomeA, City, Tribe, TA, Religion, Num, Yearg, EA, Email, Phase FROM vsbt WHERE (Fname LIKE '%" & txtSearch.Text & "%' Or Stat LIKE '" & txtSearch.Text & "%' OR Tribe LIKE '" & txtSearch.Text & "%' OR Religion LIKE '" & txtSearch.Text & "%' OR TA LIKE '" & txtSearch.Text & "%' OR EA LIKE '" & txtSearch.Text & "%' OR HomeA LIKE '" & txtSearch.Text & "%' OR City LIKE '" & txtSearch.Text & "%' OR Age LIKE '" & txtSearch.Text & "%' OR Sex LIKE '" & txtSearch.Text & "%') AND City LIKE '" & Mcity & "' ORDER BY Fname ;"
            End If
        End If
