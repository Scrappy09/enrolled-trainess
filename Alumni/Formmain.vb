...
Public Class Formmain
    ...
    Private Sub lvMain_ItemSelectionChanged(ByVal sender As Object, ByVal e As System.Windows.Forms.ListViewItemSelectionChangedEventArgs)
        ...
        selEAge = lvMain.FocusedItem.SubItems(3).Text
        selAge = lvMain.FocusedItem.SubItems(4).Text
        selBirthDate = lvMain.FocusedItem.SubItems(5).Text
        selCivilStatus = lvMain.FocusedItem.SubItems(6).Text
        selHomeAddress = lvMain.FocusedItem.SubItems(7).Text
        selCityMunicipality = lvMain.FocusedItem.SubItems(8).Text
        selContactNumber = lvMain.FocusedItem.SubItems(9).Text
        selEmail = lvMain.FocusedItem.SubItems(10).Text
        selReligion = lvMain.FocusedItem.SubItems(11).Text
        selTribe = lvMain.FocusedItem.SubItems(12).Text
        selEA = lvMain.FocusedItem.SubItems(13).Text
        selTradeArea = lvMain.FocusedItem.SubItems(14).Text
        selPhase = lvMain.FocusedItem.SubItems(15).Text
        selYearGraduated = lvMain.FocusedItem.SubItems(16).Text

    End Sub
    Private Sub loadRecord()
        Dim myCmd As New MySqlCommand
        myCmd.CommandText = "SELECT Stud, Fname, Sex, Eage, round((floor(datediff(now(),bday))/360)) AS 'age', Bday, Stat, HomeA, City, Num, Email, Tribe, Religion, EA, TA, Phase, Yearg FROM vsbt ;"
    ...
    Private Sub ChangePasswordToolStripMenuItem_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ChangePasswordToolStripMenuItem.Click
        Dim ChangePasswords As New FrmChangePassword
